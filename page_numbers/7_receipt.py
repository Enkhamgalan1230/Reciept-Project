...
def extract_adj_noun_phrases(text):
    ...
    while i < len(doc) - 3:
        ...
        # 🧠 CASE 1: compound adjective with hyphen split into 3 tokens, followed by noun
    ...
    # Catch any final noun not yet captured
