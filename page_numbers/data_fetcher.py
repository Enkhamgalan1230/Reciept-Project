...
if "df" not in st.session_state:
    ...
    def fetch_data():
        try:
            ...
            st.info("Loading fresh data from Supabase! 🍽️ Since we fetch 1,000 rows at a time, it may take a moment. Why not grab a coffee and enjoy a fun fact while you wait? ", icon="ℹ☕")
            ...
            st.success("✅ Data fetching completed!. Now you can visit other pages")
            st.balloons()
            return df
